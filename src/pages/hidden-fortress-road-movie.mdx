...
export const blog = findFilmPost(
  (b) => b.topic.toLowerCase() === 'the hidden fortress'
);
export const metadata = {
  ...blog,
  keywords: 'The Hidden Fortress, Akira Kurosawa, film analysis',
  description:
    'How Kurosawa\'s The Hidden Fortress uses a princess\'s journey through civil war to explore themes of mortality, mercy, and seeing life beyond the castle walls.',
  spoilers: true,
};
