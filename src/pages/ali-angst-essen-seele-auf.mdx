...
export const blog = findFilmPost(
  (b) => b.topic.toLowerCase() === 'ali: angst essen seele auf'
);
export const metadata = {
  ...blog,
  keywords:
    'Ali: Fear eats the soul, Ali: Angst essen Seele auf, Rainer Werner Fassbinder, film analysis',
  description:
    'How Rainer Werner Fassbinder explored prejudice and pain through Ali: Fear Eats the Soul',
};
...
<YouTubeEmbed videoId="AAhodrNP_zY" />
