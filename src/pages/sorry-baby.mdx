...
export const blog = findFilmPost(
  (b) => b.topic.toLowerCase() === 'sorry, baby'
);
export const metadata = {
  ...blog,
  keywords: 'Sorry Baby, Eva Victor, film analysis',
  description:
    'Eva Victor\'s Sorry, Baby examines how one woman navigates trauma through dark humour, exploring what helps us continue living.',
  spoilers: true,
};

Something bad happened to Agnes, but _Sorry, Baby_ doesn't dwell for too long on the event itself - in fact we only hear about it through Agnes' recollections, we do not see anything ourselves. Eva Victor focuses on how Agnes continues to live afterwards, and the things that help her through it. Everyone approaches trauma differently, and _Sorry, Baby_ lets us into the mind of someone who approaches it with laughter and sardonic wit, someone who is naturally funny and sees the absurd in every situation, who can't help but laugh when others might cry.
