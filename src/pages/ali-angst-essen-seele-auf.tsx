...
const Page = () => {
  const blog = findFilmPost(b => b.topic.toLowerCase() === "ali: angst essen seele auf");
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <p>Ali: Angst Essen Seele Auf (Ali: Fear eats the Soul), dir. by Rainer Werner Fassbinder (Arrow Films: The Rainer Werner Fassbinder Foundation, 2007)</p>

      <h6><strong>Bibliography</strong></h6>

      <p>Ebert, Roger, ‚Ali: Fear Eats the Soul’, rogerebert.com, April 27 1997, http://www.rogerebert.com/reviews/great-movie-ali-fear-eats-the-soul-1974 [Accessed: 25 April 2017]</p>
