...
const Page = () => {
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <p>
        Though the film’s message initially seems to be totally bleak, with the political allegory reinforcing the doom and gloom of the contemporary news cycle, there is a thread of hope running throughout. Families and communities might not be perfect, but they help us to survive even through the darkest of times. When we meet the doctor at last, we find that he has grown obsessed with death, erecting a monument to those who have died in the course of the outbreak in an attempt to remind people that they all will die. He explains the latin phrase “memento mori” (remember you must die) and helps Spike to come to terms with the end of his mother’s life. Death is the only inevitability in this life, change the only constant. There is something that should make us feel optimistic in that, a reminder that all things pass. When Spike starts a fire to distract the guards at the gate and escape to the mainland with his mother, we see the St George’s flag burning as he leaves: revolution through death and rebirth perhaps. The natural world healing itself as human impact lessens after the rage virus takes hold, with huge herds of deer stampeding across the lush fields and forests, is also a testament to this theme of renewal.
      </p>

      <p>
        In 28 Years Later we see a despairing look at the state of the UK, but not from someone who has given up hope, or fallen out of love with everything that is great about this island and its people.
      </p>
