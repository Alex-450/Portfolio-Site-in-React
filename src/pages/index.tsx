  ...
  return (
    <Container className="home-container flex-grow-1">
      ...
      <Row className="slide-in" style={{ animationDelay: '1.5s' }}>
        ...
        >
          <p>
            Now I'm a software developer at{' '}
            <a
              href="https://fuga.com"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="home-nav">
        ...
        >
          <div className="home-nav-content">
            ...
            <span className="home-nav-desc">
              What's showing at independent cinemas in Amsterdam and Haarlem
            </span>
          </div>
          <ArrowRight className="home-nav-arrow" size={24} />
        </Link>
