...
class About extends React.Component {
    ...
    return(
        ...
        <Container className="title-container">
            ...
            <p>I studied History & German and have spent time living in Berlin and the Austrian alps. I worked in hospitality part-time from the age of 16, until I was 24. I have worked in all sorts of places, from <a target="_blank" rel="noopener noreferrer" href="https://7bone.co.uk/">burger joints</a> to a pizzeria in a ski resort.</p>
            <p>in 2018 I joined <a target="_blank" rel="noopener" href="rekk.com">REKKI</a>, a company providing technology for a sector I had grown to love: hospitality. I started working in the customer support team and after three months transitioned to the tech team. I've been working as a QA Tester ever since and am now trying to hone my coding skills with sites like this one!</p>
